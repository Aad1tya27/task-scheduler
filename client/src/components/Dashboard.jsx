...
const Dashboard = () => {
    ...
    return (
        <>
            <div className='w-full h-[88vh]  relative z-0 flex flex-col lg:flex-row justify-center gap-5 lg:gap-0 lg:justify-center items-center'>
                <div className='w-[80%] md:w-[40%]'>
                    <form onSubmit={handleSubmit(onSubmit)} method="post" className='addNotes gap-5 flex flex-col  justify-center items-center'>
                        <div className='text-xl sm:text-2xl text-center text-shadow shadow-black text-white'>Add a Task</div>
                        ...
                        <input disabled={isSubmitting} type="submit" className='bg-[#0a0e10] hover:scale-105  text-white p-5 py-2 rounded-md' value={isSubmitting?"Adding..." :"Add" } />
                    </form>
                </div>
                ...
                <div className="showNotes shadow-[0_0px_5px_-5px_rgba(0,0,0,0.3)] p-3  flex flex-col items-center justify-center text-white w-[80%] sm:[70%] lg:w-[50%] min-h-[40vh] lg:min-h-[20vh]">
                    <div className='text-xl sm:text-2xl m-2 lg:m-5 text-shadow shadow-black'>Your Tasks</div>
